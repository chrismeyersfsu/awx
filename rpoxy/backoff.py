...
def exponential_backoff(attempt: int, base_delay: int = 2, jitter: float = 0.1, start_delay: int = 0, sleep_fn: Callable[[float], None] = None):
    """
    ...
    Args:
        ...
        sleep_fn (Callable[[float], None], optional): A function to handle sleeping. Defaults to None, which uses a no-op.
    """
